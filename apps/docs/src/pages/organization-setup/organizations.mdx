...
An organization is the home for all your workflows and interactions in Flows. We recommend creating a single organization for your company and using [environments](/organization-setup/environments) to manage different deployments effectively.
...
- Managing billing and workflows
...
Flows allows you to create multiple organizations under a single account (e.g. tied to a specific email). TIf you are using Flows for multiple projects, we recommend creating a separate organization for each project.
