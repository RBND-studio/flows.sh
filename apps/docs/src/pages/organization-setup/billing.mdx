...
**Free Plan:** Usage limits reset at the start of every month. If you reach the limit, you cannot identify new users until the next cycle, but existing users continue to access workflows without interruption.
...
- Once the limit is reached, no new users can be identified until the next billing cycle. The existing users can continue to access workflows without interruption.
