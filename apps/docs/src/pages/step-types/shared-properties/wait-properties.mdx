...
Wait for an element to appear on the page / DOM. You can specify the CSS selector of the element that should appear on the page before proceeding to the next step. Can be combined with the location property to specify on which URL the element should appear.
