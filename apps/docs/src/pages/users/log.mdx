...
Flows automatically track user events across your environments, maintaining a detailed history of interactions. This includes workflow state changes and block transitions, helping your inspect and debug user behavior.
