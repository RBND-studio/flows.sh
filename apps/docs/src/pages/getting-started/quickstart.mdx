...
![Book](/getting-started/quick-start.png)
...
To get started, you need to install the [`@flows/react`](https://www.npmjs.com/package/@flows/react) package. If you're not using React, refer to the [`@flows/js` guide](/sdk/javascript/guide) for steps 1, 2 and 3.
...
To make your workflow live click **Publish version**. Choose the environment you want to deploy to. For detailed steps, see [publishing workflows](/workflows/publishing).
