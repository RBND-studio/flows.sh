...
To get started, you need to install the Flows React SDK.
...
- [Adding blocks](/workflows/adding-blocks)
- [Configuring blocks](/workflows/configuring-blocks)

## 6. Publish your workflow

Once you have created your workflow, you can publish it to make it live in your app. Go to the **Workflows** section in the Flows dashboard, select the workflow you want to publish, and click on the **Publish** button. After that a dialog will appear where you can select the environment you want to publish the workflow to. Learn more about [publishing workflows](/workflows/publishing-workflows).
