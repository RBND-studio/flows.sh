...
The `<FlowsSlot />` is a component used to create Slots in your app where you can insert components using Workflows. [Learn more about using Slots](/block-properties/slot) in the Flows editor.
