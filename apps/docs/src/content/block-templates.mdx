...
Block templates are reusable UI components that allow you to create custom elements for [workflows](/workflows/overview). They contain properties and instructions, giving editors the power to create custom workflows. Each template must correspond to a matching component in your application.
