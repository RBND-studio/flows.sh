...
Billing is calculated based on Monthly Tracked Users (MTUs) identified across all [environments](/environments) in your organization. You are billed monthly, and subscriptions can be canceled anytime.
