...
Each version has its own `user migration` settings. The [user migration settings](/workflows/publishing#how-to-migrate-active-users) are applied to the users of an the environment every time the specific version is activated in the environment.
