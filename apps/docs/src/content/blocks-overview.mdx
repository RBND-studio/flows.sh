...
import { Start16, Block16, Tour16, Filter16, Exit16 } from "icons";
...
<Cards>
  <Card title="Start" href="/start-blocks/automatic-start" icon={<Start16 />}>
    The start of every workflow.
  </Card>
  <Card title="Components" href="/components/overview" icon={<Block16 />}>
    Display UI elements within your application.
  </Card>
  <Card title="Tour" href="/tour-block" icon={<Tour16 />}>
    Used to guide users through a series of steps.
  </Card>
  <Card title="Logic" href="/logic-blocks/overview" icon={<Filter16 />}>
    Define branching logic, conditions, and other rules.
  </Card>
  <Card title="End" href="/end-block" icon={<Exit16 />}>
    Exits the workflow.
  </Card>
</Cards>
