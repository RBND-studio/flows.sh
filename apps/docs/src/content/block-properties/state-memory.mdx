...
Create a component with an [array](/block-properties/array) named tasks. Each item in the array includes a title and a completed property that is a State memory.
...
Too see the state memory property in action, check out these live examples with source code:
