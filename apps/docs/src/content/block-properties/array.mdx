...
When you set up an array property, you can specify common attributes like title, description, and key. Additionally, you define an items property, which is a list of sub-properties that determine each array item’s structure. These sub-properties can be any basic type (e.g., String, Number, Boolean, or Select).

## Filling an array in a workflow
...
![Block template](/block-properties/array-template.png)
...
![Block template](/block-properties/array-workflow.png)
