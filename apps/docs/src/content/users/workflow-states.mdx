...
Every user you identify in Flows has a state for each workflow in your organization. You can inspect and update these states from the user detail page to troubleshoot or test [workflows](/workflows/overview) effectively.
...
You can also reset user progress using the Flows SDKs. Learn more about the [React SDK](/react/reference#resetworkflowprogress) and [JavaScript SDK](/javascript/reference#resetworkflowprogress) functions
