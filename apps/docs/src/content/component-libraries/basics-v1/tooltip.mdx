...
![Tooltip](/component-libraries/basics-v1/tooltip.png)
...
To integrate the tooltip component into your application, follow the steps described in the [library installation guide](/component-libraries/basics-v1/overview#installation).
