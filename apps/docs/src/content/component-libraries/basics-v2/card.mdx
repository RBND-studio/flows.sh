...
To integrate the card component into your application, follow the steps described in the [library installation guide](/component-libraries/basics-v2/overview#installation).
...
| Slot             | ---     | Used to render the card inside your application. Without a slot defined, the card will not be rendered. [Learn more](/block-properties/slot)                                         |
