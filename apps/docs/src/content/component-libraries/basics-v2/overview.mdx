...
import { Modal16, Tooltip16, Hint16, Banner16, Checklist16 } from "icons";
...
<Cards>
  <Card title="Tooltip" icon={<Tooltip16 />} href="/component-libraries/basics-v2/tooltip">
    Guide users with helpful tooltips.
  </Card>
  <Card title="Modal" icon={<Modal16 />} href="/component-libraries/basics-v2/modal">
    Display a modal to guide users through a process.
  </Card>
  <Card title="Hint" icon={<Hint16 />} href="/component-libraries/basics-v2/hint">
    Provide subtle hints to users.
  </Card>
  <Card title="Card" icon={<Banner16 />} href="/component-libraries/basics-v2/card">
    Show information or drive action with inline cards.
  </Card>
  <Card
    title="Floating Checklist"
    icon={<Checklist16 />}
    href="/component-libraries/basics-v2/floating-checklist"
  >
...
For Flows to be able to render the components from the Basics V2 library, you need to setup the slot components and render function for the floating blocks. Rendering of slot blocks will be handled by the [flows-slot](/javascript/reference#flows-slot) element.
