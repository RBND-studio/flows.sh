...
Time to Value (TTV) measures how long it takes for a new user to experience their first meaningful success with your product (also known as [Aha Moment](/glossary/aha-moment)). It begins the moment they sign up and ends when they reach an action or outcome that demonstrates clear value.
...
- Remove friction from [onboarding](/glossary/user-onboarding) to help users reach that value faster.
