...
All examples and templates have been updated to use Basics V2. To get started, follow the [migration guide](/docs/blocks/basics-v2/overview#migration-from-basics-v1-to-basics-v2).

You can see the new components in action in the [Tour example](/examples/tour), or explore them in the [docs](/docs/blocks/basics-v2/overview).
