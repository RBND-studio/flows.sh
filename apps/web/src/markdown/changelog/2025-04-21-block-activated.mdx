...
- The userId is now optional in the React SDK, removing the need to create special logic when fetching it asynchronously. Learn more in the [docs](/docs/sdk/react/reference#flowsprovider).
