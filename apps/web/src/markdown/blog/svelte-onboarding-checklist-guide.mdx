---
title: How to build an onboarding checklist in Svelte (SvelteKit & Vite Guide)
description: A complete guide to building a user onboarding checklist in Svelte. Learn how to create a floating checklist widget, track task completion, and ship activation flows faster with Flows.
date: "2026-07-06"
author: "Ondrej Pesicka"
image: /images/blog/onboarding-checklist-guide/svelte-cover.png
imageAlt: Floating onboarding checklist example in a Svelte application
---
...
<Image
  ...
  alt="An example of a floating onboarding checklist in a Svelte application"
  width={1800}
  height={1040}
/>
...
Now, when you start your Svelte app, you should see the checklist widget in the corner of the screen (it is possible that you will need to reload the page if you already had the app running before changing the environments). If you have any issues, you can debug by looking into the browser console or by using our SDK's [debug mode](/docs/sdk/debug).
...
If you're ready to ship better onboarding, faster, [try Flows](/technology/svelte-user-onboarding).
...
And if you want to guide users through a linear sequence of steps instead, see [How to build a product tour in Svelte](/blog/svelte-product-tour-guide).
