...
First, [sign up](https://app.flows.sh/signup), create and organization, and install the NPM package. Follow the [quick installation guide](/docs/frameworks/angular) to integrate `init()` into your Angular app (or view our [Angular template project](https://github.com/RBND-studio/flows-sdk/tree/main/examples/angular)). Once you have that set up, return here to continue.
