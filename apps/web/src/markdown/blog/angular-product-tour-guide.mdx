...
image: /images/blog/product-tour-guide/angular-cover.png
...
Publish the workflow to the staging environment in Flows, then run your Angular app to see the tour in action. You may need to reload if your app was already running. For debugging, use the browser console or the SDK’s [debug mode](/docs/sdk/debug).
