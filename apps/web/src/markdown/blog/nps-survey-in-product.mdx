...
What it does not measure is whether a specific feature works, whether last week's release landed, or how a support conversation went. Those need [CSAT or CES](/blog/survey-types-nps-csat-ces-pmf), and pointing NPS at them produces answers that are mostly noise.
