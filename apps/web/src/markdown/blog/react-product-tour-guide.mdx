...
Sign up for [Flows](https://app.flows.sh/signup) and create an organization. Then install the NPM package and follow our [quick installation guide](/docs/sdk/react/installation) to get set up (or view our [React template project](https://github.com/RBND-studio/flows-sdk/tree/main/examples)). When you have the `<FlowsProvider>` integrated into your app, come back here.
