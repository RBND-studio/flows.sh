...
Sign up for [Flows](https://app.flows.sh/signup) and create an organization. Then install the NPM package and follow our [quick installation guide](/docs/sdk/frameworks/svelte) to get set up (or view our [Svelte template project](https://github.com/RBND-studio/flows-sdk/tree/main/examples/svelte)). When you have the `init()` integrated into your app, come back here.
