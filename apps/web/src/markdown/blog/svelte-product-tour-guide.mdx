...
Sign up for [Flows](https://app.flows.sh/signup) and create an organization. Then install the NPM package and follow our [quick installation guide](/docs/frameworks/svelte) to get set up (or view our [Svelte template project](https://github.com/RBND-studio/flows-sdk/tree/main/examples/svelte)). When you have the `init()` integrated into your app, come back here.
...
Now, when you start your Svelte app, you should see the first step of the tour (it is possible that you will need to reload the page if you already had the app running before changing the environments). If you have any issues, you can debug by looking into the browser console or by using our SDK’s [debug mode](/docs/sdk-overview#debug-mode).
