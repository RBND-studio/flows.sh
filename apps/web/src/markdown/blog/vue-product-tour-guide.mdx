...
Sign up for [Flows](https://app.flows.sh/signup) and create an organization. Then install the NPM package and follow our [quick installation guide](/docs/sdk/frameworks/nuxt) to integrate `init()` into your Vue app (or view our [Vue template project](https://github.com/RBND-studio/flows-sdk/tree/main/examples/vue/nuxt)). Once you have that set up, return here to continue.
