...
import workflowEditorDarkPng from "../../components/homepage/workflows-section/workflow-editor-dark.png";
import workflowEditorLightPng from "../../components/homepage/workflows-section/workflow-editor-light.png";
import { Section } from "components/ui/section";

export const MainIllustration = (): ReactNode => {
  return (
    <>
      <Section role="img" aria-label="Illustration of a workflow with branching logic">
        <Flex
          alignItems="center"
        ...
        >
          <Block name="User signs up" type="start" icon="start" />
          <LineArrowRight />
          <Block name="Welcome modal" type="component" icon="modal" />
          <LineArrowRight />
          <Block name="Setup complete?" type="filter" icon="filter" />
          <LineFork />
      ...
      <Section
        maxWidth="1100px!"
        role="img"
        aria-label="Illustration of a workflow editor showing a multi-step flow with branching logic"
        outerClassName={css({
            ...
            >
              <Box height="100%" overflow="hidden">
                <ThemeImage
                  ...
                  alt="Workflow editor showing a multi-step flow with branching logic"
                  height={1500}
                  width={2982}
                  fetchPriority="high"
                  placeholder="blur"
    ...
    >
      ...
      >
        ...
        <path
          ...
          stroke={token.var("colors.border.neutral.strong")}
          markerEnd="url(#wf-fork-arrow)"
          markerStart="url(#wf-fork-circle)"
        />
        <path
