...
export const chameleonContent: ComparisonContentType = {
  ...
  description:
    "Flows is the Chameleon alternative for modern companies who want to build better product adoption at a fraction of the price.",
  comparisonTitle: (
    <>
      Why choose <br /> Flows vs. Chameleon?
    </>
  ),
  competitorName: "Chameleon",
  competitorLogo: <Chameleon20 />,
  comparisons: [
    {
      title: "Tooltips",
      competitor: true,
    ...
    },
    {
      ...
      flows: "Inline custom components",
    ...
    {
      title: "Localization",
      competitor: "Requires an enterprise plan",
      flows: true,
  ...
  features: [
    {
      ...
      description:
        "Chameleon gives you pre-canned elements like tooltips and modals with limited customization. Flows lets you use your own components and design system to build a native experience.",
    ...
    },
    {
      ...
      description:
        "Chameleon limits you to floating elements (modals, banners, tooltips) or inline templates. Flows supports those too, but it also lets you embed custom UI components.",
      viz: <EmbeddableComponentsIllustrations />,
    },
    {
      title: "Developer friendly",
      description:
        "Unlike Chameleon, Flows is built for developers (among others). Use our SDKs to build your own components, leverage your codebase, and create a native experience.",
      viz: (
        <Box
          h="100%"
          w="100%"
