...
export const ngxJoyrideContent: AlternativeContentType = {
  ...
  comparisons: [
    ...
    },
    {
      ...
      competitor: true,
      flows: true,
      description: `Ngx Joyride is free and open source. Flows offers a free plan with ${FREE_LIMIT} monthly tracked users.`,
    },
    {
      title: "Surveys",
      competitor: false,
      flows: true,
      description:
        "Flows includes built-in surveys for collecting user feedback. Ngx Joyride is a tour library and does not include survey capabilities.",
    },
  ],
  otherDifferences: [
    {
