...
export const FilterWorkflowExample = (): JSX.Element => {
  return (
    <Flex
      aria-hidden="true"
    ...
    >
      <Flex flexDirection="column" alignItems="center" gap="space6">
        <LineArrowDown />
        <Block name="Is Pro user?" type="filter" icon="filter" />
      </Flex>
      ...
      <Flex gap={{ base: "space16", md: "space40" }} mt="space4">
        <Block name="Satisfaction survey" type="survey" icon="survey" />
        <Block name="Upgrade hints" type="component" icon="hint" />
      </Flex>
    </Flex>
  );
};
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="25" viewBox="0 0 8 25" fill="none">
      <path
        ...
        fill="url(#paint0_linear_5780_4511)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_5780_4511"
          x1="4.18164"
          y1="-2.18557e-08"
          x2="4.18164"
          y2="24"
