...
{/*TODO: Image - screenshot of a ugly tooltip in some product*/}
...
{/*TODO: Image - User journey diagram. One path with the user "using the app" –> "interruption by a modal" -> "following tootlips", second path is the good one: "using the app" -> "empty state with inline action" -> "completing the task".*/}
...
{/*TODO: Image - Somehow show an ad blocker blocking onboarding, or we can do a infographic with how many percent of users have ad blockers, and how many of them are affected by this. 31.5% of users use ad blockers at least sometimes when online according to Backlinko https://backlinko.com/ad-blockers-users*/}
...
{/*TODO: Image - custom components illustration, can be similar to the one on the homepage*/}
...
{/*TODO: Image - embedded components illustration*/}
