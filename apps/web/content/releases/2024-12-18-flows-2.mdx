...
<Image src="/images/blog/flows-2/cover.jpg" alt="Flows logo" width={3600} height={1800} />
...
Unfortunately, existing Flows cannot be automatically migrated to the new version. However, we’ve prepared a [migration guide](/docs/migrate-to-flows-2) in our documentation to help you transition to Flows 2.0. If you have any questions or need assistance, our team is here to support you.
