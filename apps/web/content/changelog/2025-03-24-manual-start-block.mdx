...
Manual start block allows you to start a workflow manually from the SDK by calling `startWorkflow` function. Learn more in [docs](/docs/start-blocks/manual-start).
