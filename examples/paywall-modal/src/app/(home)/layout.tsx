...
export default function HomeLayout({ children }: { children: React.ReactNode }) {
  return (
    <ExampleInfo
      title="Paywall modal example"
      exampleUrl="https://flows.sh/examples/paywall-modal"
      repoUrl="https://github.com/RBND-studio/flows.sh/tree/main/examples/paywall-modal"
    >
